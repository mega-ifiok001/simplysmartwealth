...
export const metadata = {
  title: "Simply Smart Wealth - Single2",
};

export default function Single2Page() {
  return (
    <>
<main className="bg-grey pb-30">
	<div className="entry-header entry-header-style-2 pb-80 pt-80 mb-50 text-white" style={{ backgroundImage: "url(/assets/imgs/news/news-16.jpg)" }}>
		<div className="container entry-header-content">
			...
			<div className="entry-meta align-items-center meta-2 font-small color-white"><p className="mb-5 text-white"><a className="author-avatar" href="#"><img className="img-circle" src="/assets/imgs/authors/author-3.jpg" alt="" /></a> By <a href="/author"><span className="author-name font-weight-bold text-white">Barbara Cartland</span></a></p></div>
		</div>
	</div>
