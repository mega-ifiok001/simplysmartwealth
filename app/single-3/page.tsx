...
export const metadata = {
  title: "Simply Smart Wealth - Single3",
};

export default function Single3Page() {
  return (
    <>
		...
		<div className="entry-header pt-80 pb-30 mb-20">
			<div className="row">
				<div className="col-md-6 mb-md-0 mb-sm-3">
					<figure className="mb-0 mt-lg-0 mt-3 border-radius-5"><img className=" border-radius-5" src="/assets/imgs/news/news-8.jpg" alt="" /></figure>
				</div>
				<div className="col-md-6 align-self-center">
					<div className="post-content">
						<div className="entry-meta meta-0 mb-15 font-small"><a href="/category"><span className="post-cat position-relative text-info">Travel tips</span></a> <a href="/category"><span className="post-cat position-relative text-success">Food</span></a></div>
