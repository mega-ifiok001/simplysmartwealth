...
export const metadata = {
  title: "Simply Smart Wealth - Single",
};
...
<main className="bg-grey pb-30">
	<div className="container single-content">
		...
		<figure className="image mb-30 m-auto text-center border-radius-10"><img className="border-radius-10" src="/assets/imgs/news/news-1.jpg" alt="post-title" /></figure>
