		...
		<div className="container">
			<div className="row pt-20 pb-20">
				...
				<div className="col-md-9 col-xs-6 text-end header-top-right ">
					<ul className="list-inline nav-topbar d-none d-md-inline"><li className="list-inline-item menu-item-has-children"><a href="#">Layouts</a> <ul className="sub-menu font-small"><li className="menu-item-has-children"><a href="#">Pages</a> <ul className="sub-menu font-small"><li><a href="/about">About</a></li> <li><a href="/contact">Contact</a></li> <li><a href="/typography">Typography</a></li> <li><a href="/register">Register</a></li> <li><a href="/login">Login</a></li> <li><a href="/search">Search</a></li> <li><a href="/author">Author</a></li> <li><a href="/404">404 page</a></li></ul></li> <li className="menu-item-has-children"><a href="#">Category</a> <ul className="sub-menu font-small"><li><a href="/category-list">List layout</a></li> <li><a href="/category-grid">Grid layout</a></li> <li><a href="/category-masonry">Masonry layout</a></li> <li><a href="/category-big">Big layout</a></li></ul></li> <li className="menu-item-has-children"><a href="#">Single post</a> <ul className="sub-menu font-small"><li><a href="/single">Default</a></li> <li><a href="/single-2">Big image</a></li> <li><a href="/single-3">Left image</a></li> <li><a href="/single-4">With sidebar</a></li></ul></li></ul></li> <li className="list-inline-item"><a href="https://wp.alithemes.com/html/stories/docs/"><i className="elegant-icon icon_document_alt mr-5"></i>Document</a></li></ul>
